...
-- 插入测试数据（服务记录示例）
INSERT INTO service_record (task_id, volunteer_id, family_user_id, service_date, service_content, service_duration, rating) VALUES
(1, 2, 3, '2025-11-15 14:00:00', '协助关爱对象进行日常生活照料，包括做饭、打扫卫生', 120, 5),
(2, 2, 3, '2025-11-13 10:00:00', '陪同关爱对象进行心理辅导，倾听关爱对象心声', 90, 5),
(3, 2, 3, '2025-11-10 09:00:00', '陪同关爱对象前往医院体检', 180, 4);

-- 插入测试数据（关爱计划示例）
INSERT INTO care_plan (family_user_id, plan_name, description, service_type, service_frequency, start_date, end_date, status, assigned_volunteer_id, total_services, completed_services) VALUES
(3, '11月护理计划', '为关爱对象提供日常生活照料和健康护理服务', '生活照料,健康护理', '每周3次', '2025-11-01', '2025-11-30', 'ACTIVE', 2, 12, 3);

-- 插入测试数据（反馈示例）
INSERT INTO feedback (family_user_id, task_id, volunteer_id, feedback_type, title, content, rating, status) VALUES
(3, 1, 2, 'RATING', '服务非常满意', '志愿者李明服务态度很好，非常耐心细心', 5, 'RESOLVED');
