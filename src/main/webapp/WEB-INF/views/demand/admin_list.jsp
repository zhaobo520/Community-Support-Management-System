                ...
                <td>
                  <div class="actions-cell">
                    ...
                    <c:if test="${demand.status == 'PENDING'}">
                      <button class="btn btn-approve" onclick="approveDemand(${demand.id})">通过</button>
                      <button class="btn btn-reject" onclick="rejectDemand(${demand.id})">拒绝</button>
                    </c:if>
                  </div>
                </td>
              </tr>
