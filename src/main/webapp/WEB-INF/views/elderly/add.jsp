...
<div class="container">
  ...
  <form action="${pageContext.request.contextPath}/admin/elderly/add" method="post">
    ...
    <div class="form-actions">
      ...
      <button type="submit" class="btn btn-submit" onclick="return beforeSubmit()">提交</button>
    </div>
  </form>
</div>
