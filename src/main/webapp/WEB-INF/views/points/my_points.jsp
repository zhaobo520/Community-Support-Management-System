    ...
    <div class="content-grid">
        ...
        <div class="section">
            ...
            <div class="tab-buttons">
                <button class="tab-btn active" onclick="switchTab('earned')">已获得</button>
                <button class="tab-btn" onclick="switchTab('locked')">未解锁</button>
            </div>
                            ...
                            <c:forEach items="${earnedBadges}" var="badge">
                                <div class="badge-item earned">
                                    ...
                                    <div class="badge-info">
                                        ...
                                        <button class="download-cert-btn" onclick="downloadCertificate(${badge.id}, '${badge.badgeName}')">
                                            下载荣誉证书
                                        </button>
                                    </div>
                                </div>
                        ...
                        <c:when test="${not empty lockedBadges}">
                            <c:forEach items="${lockedBadges}" var="badge">
                                <div class="badge-item">
                                    <div class="badge-icon" style="filter: grayscale(100%); opacity: 0.5;">${badge.badgeIcon}</div>
                                    <div class="badge-info">
...
<script>
    ...
    function downloadCertificate(badgeId, badgeName) {
        // 显示下载提示
