  ...
  <div class="login-container">
    ...
    <div class="login-body">
      ...
      <form action="${pageContext.request.contextPath}/user/doLogin" method="post">
        <input type="hidden" name="roleHint" value="admin">
        <div class="form-group">
          <label for="username">用户名</label>
          <input type="text" name="username" id="username" class="gov-input" placeholder="请输入用户名" required value="${username}">
        </div>
