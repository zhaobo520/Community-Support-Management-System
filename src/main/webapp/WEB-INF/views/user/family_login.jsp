  ...
  <div class="login-container">
    ...
    <div class="login-body">
      ...
      <form action="${pageContext.request.contextPath}/user/doLogin" method="post">
        <input type="hidden" name="roleHint" value="family"/>
      ...
      <div class="links">
        <p>还没有账号？<a href="${pageContext.request.contextPath}/user/family/register">立即注册</a></p>
        <a href="${pageContext.request.contextPath}/user/family/appeal">申诉渠道</a> |
        <a href="${pageContext.request.contextPath}/user/family/reset-password">修改密码</a>
        <br/>
        <a href="${pageContext.request.contextPath}/user/admin/login">管理员登录</a> |
        <a href="${pageContext.request.contextPath}/user/volunteer/login">志愿者登录</a>
      </div>
    </div>
  </div>
</div>
