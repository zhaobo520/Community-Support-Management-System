...
<body>
<!-- Gov Header -->
<header class="gov-header" style="background: linear-gradient(90deg, #B71C1C 0%, #D32F2F 100%); height: 60px; padding: 0 40px; display: flex; align-items: center; justify-content: space-between; box-shadow: 0 2px 8px rgba(0,0,0,0.15); position: relative; margin-bottom: 40px;">
    <div style="position: absolute; left: 20px; color: #B71C1C; font-size: 24px;">★</div>
    <h1 style="color: white; font-size: 20px; font-weight: 600; margin-left: 50px; letter-spacing: 1px; margin: 0;">家属个人中心</h1>
    <a href="${pageContext.request.contextPath}/user/family/dashboard" style="color: white; text-decoration: none; font-size: 14px; padding: 6px 16px; border-radius: 2px;">返回首页</a>
</header>
    ...
    <div class="content">
        ...
        <div class="sidebar">
            <div class="avatar-section">
                ...
                <span class="role-badge">家属用户</span>
            </div>

            <div class="intro-box">
                <h3>角色介绍</h3>
                <p>欢迎您使用社区互助平台！作为<strong>家属用户</strong>，您可以为家中的关爱对象发布关爱需求，寻找专业志愿者提供服务。</p>
            </div>

            <div class="intro-box" style="margin-top: 15px;">
                <h3>核心功能</h3>
                <ul>
                    <li><strong>发布需求</strong> - 为关爱对象发布各类关爱需求</li>
                    <li><strong>选择志愿者</strong> - 查看并选择合适的志愿者</li>
                    <li><strong>跟踪进度</strong> - 实时跟踪任务执行情况</li>
                    <li><strong>评价反馈</strong> - 对志愿者服务进行评价</li>
                    <li><strong>长者管理</strong> - 管理家中关爱对象信息</li>
                </ul>
            </div>
            ...
            <div class="intro-box" style="margin-top: 15px;">
                <h3>服务保障</h3>
                <ul>
                    <li>所有志愿者均经过<strong>实名认证</strong></li>
                    <li>提供<strong>技能标签匹配</strong>精准推荐</li>
                    <li>支持<strong>服务评价</strong>保障质量</li>
                    <li>平台<strong>全程监督</strong>确保安全</li>
                </ul>
            </div>

            <div class="intro-box" style="margin-top: 15px;">
                <h3>温馨提示</h3>
                <p>请保持联系方式畅通，以便志愿者和平台能及时与您沟通。发布需求时请详细描述，帮助匹配更合适的志愿者。</p>
            </div>
        </div>
        ...
        <div class="main-content">
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    <div class="stat-number">家庭</div>
                    <div class="stat-label">家庭守护</div>
                </div>
                <div class="stat-card">
                    <div class="stat-number">长辈</div>
                    <div class="stat-label">关爱长辈</div>
                </div>
                <div class="stat-card">
                    <div class="stat-number">服务</div>
                    <div class="stat-label">温馨服务</div>
                </div>
            </div>
