...
<div class="container">
  <div class="appeal-container">
    <div class="appeal-header">
      <h1>志愿者申诉与建议</h1>
      <p>如您的账号被误封禁或对系统有任何建议，请在此提交申诉</p>
    </div>
    ...
    <div class="appeal-body">
      <div class="tips">
        ...
        <p style="margin: 8px 0 0 0;">
          我们重视每一位志愿者的反馈。若您的账号被禁用、审核未通过或有其他问题，请详细说明情况，我们的管理员会在24小时内回复。
        </p>
      </div>

      <form method="post" action="${pageContext.request.contextPath}/user/volunteer/submit-appeal">
        ...
        <div class="form-section">
          ...
          <div class="form-group required">
            ...
            <select id="appealType" name="appealType" class="gov-input" required>
              ...
              <option value="registration_rejected">注册审核未通过</option>
              <option value="skill_issue">技能标签相关</option>
              <option value="rating_dispute">评分异议</option>
              <option value="payment_issue">积分相关问题</option>
          ...
          <div class="form-group required">
            ...
            <textarea id="description" name="description" class="gov-input" placeholder="请详细说明您的情况，包括发生时间、具体问题等..." required></textarea>
          </div>
        ...
        <div class="btn-group">
          <a href="${pageContext.request.contextPath}/user/volunteer/login" class="btn btn-back">返回登陆</a>
